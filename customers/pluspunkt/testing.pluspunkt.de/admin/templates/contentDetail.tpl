...
<form action="" method="post" name="" enctype="multipart/form-data">
    ...
    <div class="contentBox">
        ...
        <div class="formClear"></div>
        <label for="siteTitle">Seiten Title:</label><input id="siteTitle" name="siteTitle" type="text" value="[ siteTitle ]" />
        <div class="formClear"></div>
        <label for="logoText">Logo Text:</label><input id="logoText" name="logoText" type="text" value="[ logoText ]" />
        <div class="formClear"></div>
        ...
        <div class="formClear"></div>
        <label for="dcDescription" [ menuVisible ]>Meta - DC Beschreibung:</label><textarea id="dcDescription" name="dcDescription">[ dcDescription ]</textarea>
        <div class="formClear"></div>
