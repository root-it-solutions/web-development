...
$seitentitel = "Pluspunkt Unternehmensentwicklung - Bildergalerie Inspiration 2003";
$titel = "Assessment";
$rub = "Assessment";
$hauptmenue=0;
$submenue=1;
            ...
            <table width="500" border="0" cellspacing="0" cellpadding="0">
              <tr bgcolor="#76797B" valign="top"> 
                <td bgcolor="#000000" height="350"> 
                  <p align="center"><br>
                    <a href="javascript:history.go(-1);"><img src="../_images/fotos_event/gr/inspiration_<?php  echo $_GET[bild]?>.jpg" border="1" alt="Zur&uuml;ck zur Galerie"></a></p>
                </td>
              </tr>
              <tr bgcolor="#76797B" valign="top"> 
                <td bgcolor="#000000"> 
