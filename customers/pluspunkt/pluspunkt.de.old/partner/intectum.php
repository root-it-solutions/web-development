            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="20">
              <tr bgcolor="#76797B" valign="top">
                <td>
                  ...
                  <p>Wewelsburger Straße 4 <br>
                    33154 Salzkotten <br>
                    <br>
                    Fon: 0 52 58/ 97 98-0 <br>
                    Fax: 0 52 58/ 97 98 99</p>
                  <ul>
                    <li>Beratung bei der Auswahl und Einführung<br>
                      von PPS-Systemen </li>
                    <li>Beratung bei der Einführung und Aufbau von <br>
                      Qualitätsmanagementsystemen/ Auditierung </li>
                    <li>Projektmanagement </li>
                    <li>Fachvorträge </li>
                    <li>Mitarbeiterentwicklung </li>
                    <li>Weiterbildungslehrgänge </li>
                  </ul>
