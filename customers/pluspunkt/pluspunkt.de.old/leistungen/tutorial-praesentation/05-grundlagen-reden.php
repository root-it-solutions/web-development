        ...
        <tr bgcolor="#76797B" valign="top"> 
          <td height="300"> 
            ...
            <p><img src="../../_images/link.gif" width="12" height="10" align="absmiddle"> 
              <b><a href="05-grundlagen-index.php">Grundlagen:</a></b> Redenvorbereiten</p>
            <ol>
              <li>Reden Sie &uuml;ber Themen, <br>
                <br>
                die Sie mit RECHT behandeln k&ouml;nnen <br>
                <br>
                die Sie BEWEGEN<br>
                <br>
                und die Sie GERN MITTEILEN<br>
                <br>
              </li>
              <li>Kurze Notizen machen<br>
                <br>
              </li>
              <li> Rede nicht ausschreiben<br>
                <br>
              </li>
              <li>Nicht auswendig lernen<br>
                <br>
              </li>
              <li>Beispiele bringen<br>
                <br>
              </li>
              <li>Kraftreserven entwickeln<br>
                <br>
              </li>
              <li>Die Rede &uuml;ben<br>
                <br>
              </li>
              <li>An den Ursachen arbeiten <br>
                <br>
              </li>
              <li>Niemanden nachahmen <br>
              </li>
            </ol>
            </td>
        </tr>
