        ...
        <tr bgcolor="#76797B" valign="top"> 
          <td height="300"> 
            ...
            <p><img src="../../_images/link.gif" width="12" height="10" align="absmiddle"> 
              <b><a href="05-grundlagen-index.php">Grundlagen:</a></b> Beweismittel</p>
            <p>Untermauern Sie Ihre Pr&auml;sentation durch verst&auml;ndliche 
              Argumentationen:</p>
            <ol>
              <li>Schaust&uuml;ck<br>
                <br>
              </li>
              <li>Analogie<br>
                <br>
              </li>
              <li>Vorf&uuml;hrung/ Demonstration <br>
                <br>
              </li>
              <li>Statistik <br>
                <br>
              </li>
              <li>Expertenzeugnis<br>
                <br>
              </li>
              <li>Beispiel <br>
              </li>
