        ...
        <tr bgcolor="#76797B" valign="top"> 
          <td height="300"> 
            ...
            <p><img src="../../_images/link.gif" width="12" height="10" align="absmiddle"> 
              <b><a href="10-nachbereitung-index.php">Nachbereitung:</a></b> R&uuml;ckmeldung</p>
            <p>Es gibt verschiedene Wege, auf denen Sie die Resonanz auf Ihre 
              Pr&auml;sentation erfahren k&ouml;nnen:</p>
            <ul>
              <li>Frageb&ouml;gen austeilen und einsammeln <br>
                <br>
              </li>
              <li>Auftraggeber befragen<br>
                <br>
              </li>
              <li>H&ouml;rer befragen<br>
                <br>
              </li>
              <li>mit Kollegen besprechen <br>
              </li>
            </ul>
          </td>
        </tr>
