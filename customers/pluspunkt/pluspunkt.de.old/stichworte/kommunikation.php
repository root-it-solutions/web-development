...
$seitentitel = "Pluspunkt Unternehmensentwicklung - Kommunikation";
$titel = "kommunikation";
$hauptmenue=1;
$submenue=3;
?>
                      ...
                      <td valign="top">
                        <table width="100%" border="0" cellspacing="0" cellpadding="20" height="173">
                          <tr bgcolor="#76797B" valign="top">
                            <td bgcolor="#76797B">
                              <p><b><img src="../_images/rub-kommunikation.gif" width="266" height="20"></b></p>
                              <p>Wir vermitteln Ihnen das Rüstzeug für sicheres
                                Auftreten, Verstehen und verstanden werden. <br>
                                <br>
