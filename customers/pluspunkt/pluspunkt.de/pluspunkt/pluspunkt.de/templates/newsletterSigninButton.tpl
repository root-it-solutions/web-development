            ...
            <input type="hidden" name="todo" value="newsletterSignin" />
             <table>
                 ...
                 <tr>
                    ...
                    <br /><a style="color:#000;" href="#" onclick="document.getElementById('captcha').src = '[ imagesdir ]/securimage_show.php?' + Math.random(); return false">Bild neuladen.</a>
                    </td>
