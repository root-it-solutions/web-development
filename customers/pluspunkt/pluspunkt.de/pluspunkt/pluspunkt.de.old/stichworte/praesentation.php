...
$seitentitel = "Pluspunkt Unternehmensentwicklung - Präsentation";
$titel = "praesentation";
$hauptmenue=1;
$submenue=3;
?>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="20" height="173">
                          <tr bgcolor="#76797B" valign="top"> 
                            <td bgcolor="#76797B"> 
                              ...
                              <p>Wir vermitteln Ihnen das Rüstzeug mit dem Sie 
                                auf der Grundlage Ihrer Persönlichkeit professionell 
