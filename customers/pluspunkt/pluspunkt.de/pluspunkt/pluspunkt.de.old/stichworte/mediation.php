...
$seitentitel = "Pluspunkt Unternehmensentwicklung - Mediation";
$titel = "mediation";
$hauptmenue=1;
$submenue=3;
?>
                      ...
                      <td valign="top"> 
                        <table width="100%" border="0" cellspacing="0" cellpadding="20" height="173">
                          <tr bgcolor="#76797B" valign="top"> 
                            <td bgcolor="#76797B"> 
                              <p><b><img src="../_images/rub-mediation.gif" width="266" height="20"></b></p>
                              <p>Wo Konsens und Ausgleich nicht aus eigenen Kräften 
                                erzielt werden können, moderieren wir diesen Konflikt 
                                zur Lösung. </p>
                            </td>
                          </tr>
                        </table>
