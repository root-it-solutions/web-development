...
<TR><TD><B><?php etranslate("Date format")?>:</B></TD>
  <TD><SELECT NAME="pref_DATE_FORMAT">
  <?php
...
<TH WIDTH="14%" BGCOLOR="<?php echo $prefarray["THBG"]?>"><FONT COLOR="<?php echo $prefarray["THFG"]?>"><?php etranslate("Sun")?></FONT></TH>
<?php } ?>
</TR>
<?php
