...
function print_entry ( $id, $date, $time, $duration,
  ...
  if ( $pri == 1 ) echo "<span style=\"background: #FCFDCA\">";
  if ( $pri == 3 ) echo "<span style=\"background: #FEC1AE\">";
...
//  if ( $pri == 3 ) $hour_arr[$ind] .= "<B>";
  if ( $pri == 1 ) $hour_arr[$ind] .= "<span style=\"background: #FCFDCA\">";
  if ( $pri == 3 ) $hour_arr[$ind] .= "<span style=\"background: #FEC1AE\">";
    ...
    if ( $row = dbi_fetch_row ( $res ) ) {
      if ( $row[0] > 0 )
        echo translate("You have") . " <A CLASS=\"navlinks\" " .
          "HREF=\"list_unapproved.php\">" . $row[0] . " " .
          ( $row[0] > 1 ? translate("unapproved event") :
          translate("unapproved event") ) .
          "</A><BR>\n";
    }
    dbi_free_result ( $res );
  }
