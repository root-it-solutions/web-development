        ...
        <tr bgcolor="#76797B" valign="top"> 
          <td height="300"> 
            ...
            <p><img src="../../_images/link.gif" width="12" height="10" align="absmiddle"> 
              <b><a href="02-hauptteil-index.php">Hauptteil:</a> </b> Analytische 
              Methode </p>
            <p>Wenn Sie eine Probleml&ouml;sung systematisch entwickeln, gehen 
              Sie wie folgt vor:</p>
            <p>Darlegung des Problems</p>
            <p>Ursachen er&ouml;rtern</p>
            <p>L&ouml;sungen vorstellen</p>
            <p>Beste L&ouml;sung ausw&auml;hlen</p>
            </td>
        </tr>
      </table>
    </td>
