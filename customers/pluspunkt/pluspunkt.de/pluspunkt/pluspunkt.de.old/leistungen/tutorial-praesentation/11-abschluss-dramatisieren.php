        ...
        <tr bgcolor="#76797B" valign="top"> 
          <td height="300"> 
            ...
            <p><img src="../../_images/link.gif" width="12" height="10" align="absmiddle"> 
              <b><a href="11-abschluss-index.php">Abschluss:</a></b> Dramatisieren</p>
            <ul>
              <li>Ein letztes Dia zeigt das vollendete Geb&auml;ude<br>
                <br>
              </li>
              <li>Ein vergr&ouml;&szlig;erter Scheck zeigt die Spendensumme der 
                Gemeinschaft <br>
                <br>
              </li>
              <li>Ein Symbol des Erfolges wird jedem ausgeh&auml;ndigt <br>
              </li>
            </ul>
          </td>
        </tr>
