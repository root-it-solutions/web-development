        ...
        <tr bgcolor="#76797B" valign="top"> 
          <td height="300"> 
            ...
            <p><img src="../../_images/link.gif" width="12" height="10" align="absmiddle"> 
              <b><a href="05-grundlagen-index.php">Grundlagen:</a></b> Probleml&ouml;sung</p>
            <p>Die probleml&ouml;senden Fragen bestechen durch ihre Logik und 
              sind von Ihren Zuh&ouml;ren schnell nachzuvollziehen:</p>
            <ol>
              <li>Was ist die Situation?<br>
                <br>
              </li>
              <li>Was sind die Ursachen? <br>
                <br>
              </li>
              <li>Was sind m&ouml;gliche L&ouml;sungen? <br>
                <br>
              </li>
              <li>Was ist die bestm&ouml;gliche L&ouml;sung? <br>
                <br>
              </li>
              <li>Welche Schritte werden unternommen? <br>
              </li>
            </ol>
          </td>
        </tr>
