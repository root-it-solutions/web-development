        ...
        <tr bgcolor="#76797B" valign="top"> 
          <td height="300"> 
            ...
            <p><img src="../../_images/link.gif" width="12" height="10" align="absmiddle"> 
              <b><a href="02-hauptteil-index.php">Hauptteil:</a> </b> &Uuml;berzeugungsformel</p>
            <ol>
              <li>Beweisf&uuml;hrung durch Beispiele<br>
                <br>
              </li>
              <li>Aufforderung zu einer Handlung<br>
                <br>
              </li>
              <li>Nutzen f&uuml;r den H&ouml;rer nennen</li>
            </ol>
            <p></p>
          </td>
        </tr>
