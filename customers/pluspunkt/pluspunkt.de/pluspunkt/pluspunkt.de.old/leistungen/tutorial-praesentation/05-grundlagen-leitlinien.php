        ...
        <tr bgcolor="#76797B" valign="top"> 
          <td height="300"> 
            ...
            <p><img src="../../_images/link.gif" width="12" height="10" align="absmiddle"> 
              <b><a href="05-grundlagen-index.php">Grundlagen:</a></b> Leitlinien</p>
            <ol>
              <li>Kennen Sie Ihr Material so gut, als ob Sie es besitzen w&uuml;rden.<br>
                <br>
              </li>
              <li>Entwickeln Sie positive Gef&uuml;hle zum Thema Ihrer Pr&auml;sentation.<br>
                <br>
              </li>
              <li>&Uuml;bermitteln Sie Ihren H&ouml;rern den Wert und die Bedeutung 
                Ihrer Botschaft. <br>
                <br>
              </li>
              <li>Stellen Sie sich auf die Ideen und W&uuml;nsche Ihrer Zuh&ouml;rer 
                ein. <br>
              </li>
            </ol>
          </td>
