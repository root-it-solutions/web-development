...
{
?>
      <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:;"><img src="<?php  echo $seminare_ok["externpic"];?>" width="80" height="80" border="0" onMouseDown="MM_openBrWindow('<?php  echo $seminare_ok["externlink"];?>','','width=640,height=400')"></a></p>
<?php 
}
