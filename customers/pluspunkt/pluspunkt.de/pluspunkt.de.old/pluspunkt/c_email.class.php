...
class c_email
{
	...
	IF ($_POST[art] == "magazin")
	{
		IF (isset($dateiname) && $dateiname != "") { require_once($pfad1."c_email_file_mag.inc.php"); } ELSE { require_once($pfad1."c_email_nofile_mag.inc.php");  }    
	}
	ELSEIF ($_POST[art] == "text")
	{
		IF (isset($dateiname) && $dateiname != "") { require_once($pfad1."c_email_file_txt.inc.php"); } ELSE { require_once($pfad1."c_email_nofile_txt.inc.php");  }    
	}
	ELSE
	{
		IF (isset($dateiname) && $dateiname != "") { require_once($pfad1."c_email_file.inc.php"); } ELSE { require_once($pfad1."c_email_nofile.inc.php");  }    
	}
    }
	...
	mail("$Empf_email", "$Betreff", "", "$Header", "-fnewsletter@enwhp.org");
    }
