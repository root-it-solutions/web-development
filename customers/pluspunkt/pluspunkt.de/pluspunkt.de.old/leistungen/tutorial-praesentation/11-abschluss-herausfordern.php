        ...
        <tr bgcolor="#76797B" valign="top"> 
          <td height="300"> 
            ...
            <p><img src="../../_images/link.gif" width="12" height="10" align="absmiddle"> 
              <b><a href="11-abschluss-index.php">Abschluss:</a></b> Herausfordern</p>
            <ul>
              <li>&#147;Jetzt h&auml;ngt alles von Ihnen ab, meine Damen und Herren!&#148; 
                <br>
                <br>
              </li>
              <li> &#147;Nur Sie k&ouml;nnen dieses Ziel erreichen!&#148;<br>
                <br>
              </li>
              <li>&#147;Ohne Sie bleibt unser Projekt ein Luftschloss!&#148; </li>
            </ul>
          </td>
        </tr>
      </table>
