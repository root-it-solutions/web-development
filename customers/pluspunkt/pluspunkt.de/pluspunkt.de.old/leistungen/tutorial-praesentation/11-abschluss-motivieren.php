        ...
        <tr bgcolor="#76797B" valign="top"> 
          <td height="300"> 
            ...
            <p><img src="../../_images/link.gif" width="12" height="10" align="absmiddle"> 
              <b><a href="11-abschluss-index.php">Abschluss:</a></b> motivieren</p>
            <ul>
              <li>&#147;Bedenken Sie: Keine Geldsorgen mehr!&#148;<br>
                <br>
              </li>
              <li>&#147;Sehen Sie das Bild Ihrer gl&uuml;cklichen, gesunden und 
                geborgenen Kinder!&#148; <br>
                <br>
              </li>
              <li>&#147;Stellen Sie sich vor, wie Sie bei unserem n&auml;chsten 
                Treffen Ihre Auszeichnung in Empfang nehmen!&#148; <br>
              </li>
            </ul>
          </td>
        </tr>
