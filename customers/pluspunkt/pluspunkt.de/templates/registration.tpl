...
<div class="formular">
    <form name="contactForm" id="contactForm" action="" method="post">
        <input type="hidden" name="todo" value="inspirationRegistration" />
         <table>
             <tr>
             ...
             <tr>
                 <td class="first">Anzahl Erwachsene *</td>
                 <td class="wert"><input name="adult" id="adult" type="text" value="[ formAdult ]" class="validate[required] text-input" /></td>
             </tr>
             <tr>
                 <td class="first">Namen der Erwachsenen *</td>
                 <td class="wert"><input name="adultNames" id="adultNames" type="text" value="[ formAdultNames ]" class="validate[required] text-input" /></td>
             </tr>
             <tr>
                 <td class="first">Anzahl Kinder *</td>
                 <td class="wert"><input name="children" id="children" type="text" value="[ formChildren ]" class="validate[required] text-input" /></td>
             </tr>
             <tr>
                 <td class="first">Namen der Kinder *</td>
                 <td class="wert"><input name="childrenNames" id="childrenNames" type="text" value="[ formChildrenNames ]" class="validate[required] text-input" /></td>
             </tr>
             <tr>
                 <td class="first">Alter der Kinder</td>
                 <td class="wert"><input name="childrenAge" id="childrenAge" type="text" value="[ formChildrenAge ]" /></td>
             </tr>
             <tr>
                 <td class="first">Wir nehmen an der Feier teil</td>
                 <td class="wert"><input name="feier" id="feier" type="checkbox" value="1" /></td>
             </tr>
             <tr>
                <td class="first">
                    <br />
                ...
                <td class="wert"><br /><br /><br /><br /><input type="text" name="captcha_code" id="captcha_code" size="10" maxlength="6" class="validate[required] text-input" /><a href="#" onclick="document.getElementById('captcha').src = '[ imagesdir ]/securimage_show.php?' + Math.random(); return false">[ Different Image ]</a></td>
             </tr>
             <tr>
