...
<form action="" method="post" name="" enctype="multipart/form-data">
    ...
    <!-- siteOptions end -->
    <h2><span class="coloredGrey">Liste:</span> [ todoHeadline ]</h2>

    <div class="contentTitle">Listeninhalt</div>
    <div class="contentBox">
        <label for="name">Name:</label><input id="name" name="name" type="text" value="[ name ]" />
        <div class="formClear"></div>
        <label for="description">Beschreibung:</label><textarea id="description" name="description">[ description ]</textarea>
        <div class="formClear"></div>
    </div>
</form>
