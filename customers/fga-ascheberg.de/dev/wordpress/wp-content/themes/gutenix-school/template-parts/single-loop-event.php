...
while (have_posts()) : the_post();
    ...
    <div class="content-event-wrap">
        <div class="content-event-left-col">
            <?php gutenix_post_thumbnail(array('size' => gutenix_has_sidebar() ? 'gutenix-thumb-post' : 'full',)); ?>

            <?php do_action('gutenix_school_after_event_thumbnail') ?>
        </div>
        <div class="content-event-right-col">
            <?php the_content(); ?>
        </div>
    </div>
