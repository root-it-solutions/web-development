	...
	class CX_Customizer {
		...
		public function add_control( $id, $args ) {
			...
			switch ( $field_type ) {
				...
				case 'gutenix-radio-image':
						$choices      = ( isset( $args['choices'] ) ) ? $args['choices'] : array();
						$control_args = wp_parse_args( array(
							'type'    => 'gutenix-radio-image',
							'choices' => $choices,
						), $control_args );
						
						$control_class = 'Gutenix_Customizer_Radio_Image_Control';
					break;

				case 'gutenix-buttonset':
						$choices      = ( isset( $args['choices'] ) ) ? $args['choices'] : array();
						$control_args = wp_parse_args( array(
							'type'    => 'gutenix-buttonset',
							'choices' => $choices,
						), $control_args );
						
						$control_class = 'Gutenix_Customizer_Buttonset_Control';
					break;

				case 'gutenix-alphacolor':
						$palette 		= ( isset( $args['palette'] ) ) ? $args['palette'] : array();
						$show_opacity 	= ( isset( $args['show_opacity'] ) ) ? $args['show_opacity'] : array();
						$control_args = wp_parse_args( array(
							'type'    => 'gutenix-alphacolor',
							'palette' => $palette,
							'show_opacity' => $show_opacity,
						), $control_args );

						$control_class = 'Gutenix_Customizer_Alpha_Color_Control';
					break;
				...
				case 'gutenix-sortable':
						$choices      = ( isset( $args['choices'] ) ) ? $args['choices'] : array();
						$control_args = wp_parse_args( array(
							'type'    => 'gutenix-sortable',
							'choices' => $choices,
						), $control_args );
						
						$control_class = 'Gutenix_Customizer_Sortable_Control';
					break;

				case 'gutenix-multi-check':
						$choices      = ( isset( $args['choices'] ) ) ? $args['choices'] : array();
						$control_args = wp_parse_args( array(
							'type'    => 'gutenix-multi-check',
							'choices' => $choices,
						), $control_args );
						
						$control_class = 'Gutenix_Customizer_Multicheck_Control';
					break;

				case 'gutenix-multi-field':
						$control_args = wp_parse_args( array(
							'type'    => 'gutenix-multi-field',
						), $control_args );
						
						$control_class = 'Gutenix_Customizer_Multifield_Control';
					break;

				case 'gutenix-toggle-checkbox':
						$control_args = wp_parse_args( array(
							'type' => $field_type,
						), $control_args );
						
						$control_class = 'Gutenix_Customizer_Toggle_Checkbox';
					break;

				case 'gutenix-dimensions':
						$choices 			= ( isset( $args['choices'] ) ) ? $args['choices'] : array();
						$linked_choices 	= ( isset( $args['linked_choices'] ) ) ? $args['linked_choices'] : array();
						$responsive 		= ( isset( $args['responsive'] ) ) ? $args['responsive'] : array();
						$unit_choices 		= ( isset( $args['unit_choices'] ) ) ? $args['unit_choices'] : array();
						$input_attrs 		= ( isset( $args['input_attrs'] ) ) ? $args['input_attrs'] : array();
						
						$control_args = wp_parse_args( array(
							'type' 				=> $field_type,
							'choices' 			=> $choices,
							'linked_choices' 	=> $linked_choices,
							'responsive' 		=> $responsive,
							'unit_choices' 		=> $unit_choices,
							'input_attrs' 		=> $input_attrs,
						), $control_args );
						
						$control_class = 'Gutenix_Customizer_Dimensions_Control';
					break;

				case 'gutenix-heading':
						$control_class = 'Gutenix_Customizer_Heading_Control';
					break;

				case 'gutenix-input-responsive':
						$input_attrs  		= ( isset( $args['input_attrs'] ) ) ? $args['input_attrs'] : array();
						$unit_choices 		= ( isset( $args['unit_choices'] ) ) ? $args['unit_choices'] : array();
						...
						$control_class = 'Gutenix_Customizer_Input_Responsive_Control';
					break;
				...
				case 'gutenix-range':
						...
						$control_class = 'Gutenix_Customizer_Range_Control';
					break;

				case 'gutenix-separator':
						$control_class = 'Gutenix_Customizer_Separator_Control';
					break;
				...
				default:
						...
						$control_args = apply_filters(
							'gutenix_cx_customizer/control_args/{$field_type}',
							$control_args,
							$id,
							$this
						);
			 ...
			 * @param object $this         Cherry_Customizer instance.
			 */
			$control_args = apply_filters( 'gutenix_cx_customizer/control_args', $control_args, $id, $this );
			 ...
			 * @param object $this         Cherry_Customizer instance.
			 */
			$control_class = apply_filters( 'gutenix_cx_customizer/control_class', $control_class, $id, $this );
		...
		public function get_control_section( $args ) {
			...
			$default_sections = apply_filters( 'gutenix_cx_customizer/core_sections', array(
				'title_tagline',
				'colors',
				'header_image',
				'background_image',
		...
		public function get_image_types() {
			 ...
			 */
			return apply_filters( 'gutenix_cx_customizer/image_types', array(
		...
		public function prepare_fonts() {
			 ...
			 */
			$this->fonts = apply_filters( 'gutenix_cx_customizer/fonts_list', $this->fonts, $this );
		...
		public function get_fonts_data() {
			 ...
			 * @param object $this Cherry_Customiser instance.
			 */
			return apply_filters( 'gutenix_cx_customizer/fonts_data', array(
