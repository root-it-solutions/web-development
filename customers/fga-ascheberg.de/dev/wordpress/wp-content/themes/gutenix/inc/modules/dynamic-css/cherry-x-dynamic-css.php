...
if ( ! class_exists( 'CX_Dynamic_CSS' ) ) {
	...
	class CX_Dynamic_CSS {
		...
		public function init_collector() {
			...
			require_once get_theme_file_path( 'inc/modules/dynamic-css/inc/class-cx-dynamic-css-collector.php' );
		...
		public function get_css_varaibles() {
			...
			if ( ! empty( $this->args['options_cb'] ) && is_callable( $this->args['options_cb'] ) ) {
				 ...
				 */
				$this->variables = apply_filters( 'gutenix_cx_dynamic_css/variables', $this->variables, $this->args );
			 ...
			 * @param array $this->args module arguments.
			 */
			$var_list = apply_filters( 'gutenix_cx_dynamic_css/var_list', $var_list, $this->args );
			 ...
			 * @param array $this->args module arguments.
			 */
			$this->variables = apply_filters( 'gutenix_cx_dynamic_css/variables', $variables, $this->args );
		...
		public function get_css_functions() {
			...
			require_once get_theme_file_path( 'inc/modules/dynamic-css/inc/class-cx-dynamic-css-utilities.php' );
			 ...
			 * @param array $this->args module arguments.
			 */
			return apply_filters( 'gutenix_cx_dynamic_css/func_list', $func_list, $this->args );
		}
		...
		public function get_inline_css() {
			 ...
			 * @var   array
			 */
			$this->css_reserved = apply_filters( 'gutenix_cx_dynamic_css/reserved_words_list', $this->css_reserved );
			 ...
			 */
			do_action( 'gutenix_cx_dynamic_css/include_custom_files', $this->args );
			 ...
			 * @param array  $this->args module arguments.
			 */
			$parsed_css = apply_filters( 'gutenix_cx_dynamic_css/parsed_styles', $parsed_css, $this->args );
		...
		public function print_inline_css() {
			...
			printf( '<style type="text/css">%s</style>', esc_attr( $parsed_css ) );
		}
