...
if ( ! class_exists( 'CX_Fonts_Manager' ) ) {
	...
	class CX_Fonts_Manager {
		...
		function __construct( array $args = array() ) {
			...
			$this->fonts_host = apply_filters( 'gutenix_cx_fonts_manager/cdn_url', $this->fonts_host );
		...
		public function build_fonts_url() {
			 ...
			 */
			$this->fonts_data = apply_filters( 'gutenix_cx_fonts_manager/fonts_data', $this->fonts_data, $this->args );
