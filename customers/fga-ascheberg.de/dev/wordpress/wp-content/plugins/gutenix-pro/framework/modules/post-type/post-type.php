...
class Gutenix_Pro_CPT {
     ...
     *
     * @var string $textdomain Used for internationalising. Defaults to "gutenix_pro" without quotes.
     */
    public $textdomain = 'gutenix_pro';
    ...
    function register_post_type() {
        ...
        $labels = array(
            ...
            'all_items'          => sprintf( esc_html__( '%s', $this->textdomain ), $plural ),
    ...
    function register_taxonomy($taxonomy_names, $options = array()) {
        ...
        $labels = array(
            ...
            'separate_items_with_commas' => sprintf( esc_html__( 'Seperate %s with commas', $this->textdomain ), $plural ),
                    ...
                    if ( is_array( $this->taxonomies ) ) {
                        ...
                        foreach( $this->taxonomies as $tax ) {
                            ...
                            if( $tax !== 'category' && $tax !== 'post_tag' ) {
                                ...
                                $new_columns[ $tax ] = sprintf( esc_html__( '%s', $this->textdomain ), $taxonomy_object->labels->name );
                            }
                        }
                    }
                }
        ...
        switch( $column ) {
            ...
            case ( taxonomy_exists( $column ) ) :
                ...
                // If no terms found.
                    ...
                    // Echo no terms.
                    printf( esc_html__( 'No %s', $this->textdomain ), $taxonomy_object->labels->name );
                }
    ...
    */
            ...
            if ( ! empty( $filters ) ) {
                ...
                foreach ( $filters as $tax_slug ) {
                    ...
                    if ( $terms ) {
                        ...
                        // Default show all.
                        printf( '<option value="0">%s</option>', sprintf( esc_html__( 'Show all %s', $this->textdomain ), $tax->label ) );
    ...
    function updated_messages( $messages ) {
        ...
        $messages[$this->post_type_name] = array(
            ...
            9 => sprintf(
                esc_html__( '%2$s scheduled for: <strong>%1$s</strong>.', $this->textdomain ),
